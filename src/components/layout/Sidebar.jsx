                  ...
                  {group.items.map((item) => {
                    ...
                    const link = (
                      <Link
                        ...
                        className={`group relative ${collapsed ? 'w-[73px]' : ''} flex rounded-xl text-sm font-medium transition-[background-color,color] duration-200 ease-out motion-reduce:transition-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background ${collapsed ? "h-[4.25rem] flex-col justify-center gap-0.5 px-2 py-1" : "h-11 items-center gap-3 px-3"} ${isActive ? "bg-sidebar-active text-primary" : "text-muted-foreground hover:bg-muted hover:text-foreground"}`}
                      >
